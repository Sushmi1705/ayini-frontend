        ...
        <Row>
          ...
          <Col lg={6}>
            ...
            <div className="p-3 bg-light">
              <Toast onClose={() => setShowTranslucent(false)} show={showTranslucent} delay={4000} autohide>
                <Toast.Header>
                  <img src={logo} alt="brand-logo" height="12" className="me-1" />
                  <strong className="me-auto">uBold</strong>
                  <small className="ms-5">11 mins ago</small>
            ...
            <div className="p-3">
              ...
              minHeight: "200px"
                ...
                right: 0
                  ...
                  return <Toast key={index} onClose={() => handleClose(index)} delay={5000} autohide>
                        <Toast.Header>
                          <img src={logo} alt="brand-logo" height="12" className="me-1" />
                          <strong className="me-auto">uBold</strong>
  ...
  return <>
      <Card>
        <Card.Body>
          ...
          <Toast className="d-flex align-items-center mt-4" show={showCustom1} onClose={() => setShowCustom1(false)} delay={3000} autohide>
            <Toast.Body>Hello, world! This is a toast message.</Toast.Body>
            <Button variant="" onClick={() => setShowCustom1(false)} className="btn-close ms-auto me-2"></Button>
          </Toast>
          <Toast className="d-flex align-items-center text-white bg-primary border-0 mt-4" show={showCustom2} onClose={() => setShowCustom2(false)} delay={4000} autohide>
            <Toast.Body>Hello, world! This is a toast message.</Toast.Body>

            <Button variant="" onClick={() => setShowCustom2(false)} className="btn-close btn-close-white ms-auto me-2"></Button>
          </Toast>
          <Toast className="mt-4" show={showCustom3} onClose={() => setShowCustom3(false)} delay={6000} autohide>
            <Toast.Body>
          ...
          <Toast className="text-white bg-primary mt-4" show={showCustom4} onClose={() => setShowCustom4(false)} delay={8000} autohide>
            <Toast.Body>
              Hello, world! This is a toast message.
              <div className="mt-2 pt-2 border-top">
  ...
  return <>
      <Card>
        <Card.Body>
          ...
          {(colors || []).map((color, index) => {
          return <Alert variant={color} key={index} className={classNames("bg-" + color, "border-0", color === "light" ? "text-dark" : "text-white", color === "dark" ? "text-light" : "text-white")}>
                This is a <strong>{color}</strong> alert—check it out!
              </Alert>;
        })}
        </Card.Body>
...
const DismissibleCustomBackgroundAlerts = () => {
  ...
  return <Card>
      <Card.Body>
        ...
        {(colors || []).map((color, index) => {
        return <Alert variant={color} key={index} onClose={() => handleClose(index)} className={classNames("bg-" + color, "border-0", color === "light" ? "text-dark" : "text-white", color === "dark" ? "text-light" : "text-white")} dismissible>
              <strong>{color} - </strong> A simple {color} alert—check it out!
            </Alert>;
      })}
      </Card.Body>
