...
import { Row, Col, Card, Tab, Nav, Accordion, Button, Collapse, useAccordionButton, AccordionContext } from "react-bootstrap";
...
const CustomToggle = ({
  ...
  return <h5 className={containerClass}>
      <Link to="#" className={classNames(linkClass, {
...
const CustomAccordion2 = ({
  ...
  return <>
      <Card className="mb-0">
        <Card.Header>
          <CustomToggle eventKey={String(index)} containerClass="m-0 position-relative" linkClass="custom-accordion-title text-reset d-block">
            Q. {item.title}
...
const HorizontalCollapse = () => {
  ...
  return <>
      ...
      <Collapse in={open} dimension="width">
        <div>
          <Card as={Card.Body} className="mb-0" style={{
          width: "450px"
        }}>
