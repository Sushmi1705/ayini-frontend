...
const Payments = React.lazy(() => import("../pages/apps/Ecommerce/payments"));
// - crm pages
...
const appRoutes = [ecommerceAppRoutes, crmAppRoutes, emailAppRoutes, socialAppRoutes, companiesAppRoutes, projectAppRoutes, taskAppRoutes, contactsRoutes, ticketsRoutes, fileAppRoutes];
