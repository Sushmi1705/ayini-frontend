...
const PasswordInput = ({
  ...
  return <>
        ...
        if (refCallback) refCallback(r);
      }} className={className} isInvalid={errors && errors[name] ? true : false} {...(register && register(name))}
 autoComplete={name} />
...
const FormInput = ({
  ...
  return <>
            {type === "hidden" ? <input type={type} name={name} {...(register && register(name))}
 {...otherProps} /> : <>
                    {type === "password" ? <>
                            <Form.Group className={containerClass}>
                                {label ? <>
 ...
 rows={rows} {...otherProps} autoComplete={name}>
                                        {children ? children : null}
                                    </Form.Control>
